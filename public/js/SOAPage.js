...
function renderTable(data) {
  ...
  data.forEach(soa => {
        ...
        var exportIcon = `
          <a href="#">
            <svg class="ic_export" xmlns="http://www.w3.org/2000/svg" onclick="openText(this.getAttribute('value'))" value='${soa.soa_number}' width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
